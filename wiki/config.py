...
CORPUS_FILE = os.path.join(DIR_CORPUS, "hirakata_corpus.txt")
CORPUS_FILE_JSON = os.path.join(DIR_CORPUS, "hirakata_corpus.json")
CORPUS_TARGET_FILES = os.path.join(DIR_CORPUS, "hirakata_corpus_target_files.json")
# パラメータの指定 --- (*3)
